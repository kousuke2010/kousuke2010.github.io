...
-----------------------------------------------------------------------
@StartTime: 2017-01-16 13:54:37

D:\wamp\www\wj\trunk\App\Tpl\Default\_layout\finder.html
<footer>
    <div class="container">
        <div class="line"></div>
        <section class="security">
            <ul>
                <li class="first">安全保障</li>
                <li><a href="/laiyuan">产品来源</a></li>
                <li><a href="/about/203.html">证件资质</a></li>
                <li><a href="/about/209.html">风控体系</a></li>
                <li><a href="/about/546.html">第三方电子签章</a></li>
                <li><a href="/about/332.html">第三方资金托管</a></li>
            </ul>
        </section>
        <section class="policy">
            <ul>
                <li class="first">网站政策</li>
                <li><a href="/about/333.html">法律声明</a></li>
                <li><a href="/about/216.html">注册协议</a></li>
                <li><a href="/gonggao/tags-1109.html" target="_blank">运营公告</a></li>
            </ul>
        </section>
        <section class="about">
            <ul>
                <li class="first">关于我们</li>
                <li><a href="/about/198.html">公司介绍</a></li>
                <li><a href="/baodao">媒体报道</a></li>
                <li><a href="/about/443.html">发展历程</a></li>
                <li><a href="/Act/funnote">功能上新</a></li>
            </ul>
        </section>
        <section class="service">
            <ul>
                <li class="first">客服热线</li>
                <li class="clearfix"><span class="phone"></span>全国服务热线</li>
                <li class="bottom_num">400-822-1988</li>
                <li class="worktime">人工服务时间：9:00-21:00</li>
            </ul>
        </section>
        <section class="qr" class="clearfix">
            <ul>
                <li class="first">加入官方微信</li>
                <li class="icon2 qr_bottom"></li>
                <li class="follow">
                    关注我们：
                    <a rel="nofollow" target="_blank" href="//weibo.com/wjcaifu" class="icon2 sina"></a>
                    <a rel="nofollow" target="_blank" href="//shang.qq.com/wpa/qunwpa?idkey=05b58eea4fd2f723e9008970d402971e1b87450feb46f838f9220d4354674c65" class="icon2 qq"></a>
                </li>
            </ul>
        </section>
        <div class="clear"></div>
        <div class="words clearfix">
            <div class="instation">站内链接：<a href="//www.wujiecaifu.com/pingtai" target="_blank">网贷平台</a> | &nbsp;&nbsp;<a href="//www.wujiecaifu.com/p2b" target="_blank">p2b理财讲堂</a></div>
            <div class="warns">2014 © <a href="//www.wujiecaifu.com/">无界财富</a> | &nbsp;备案号：粤ICP备15054447号-1</div>
            <block name="appendlinks"></block>
        </div>
        <div class="verify">
            <span id="aq_verify"><a rel="nofollow" key ="55935440efbfb02454b5073d" logo_size="124x47" logo_type="business" href="//www.anquan.org"></span>
            <script src="//static.anquan.org/static/outer/js/aq_auth.js"></script></a>
            <span id="kx_verify"></span>
            <script type="text/javascript">(function (){var _kxs = document.createElement('script');_kxs.id = 'kx_script';_kxs.async = true;_kxs.setAttribute('cid', 'kx_verify');_kxs.src = ('https:' == document.location.protocol ? 'https://ss.knet.cn' : '//rr.knet.cn')+'/static/js/icon3.js?sn=e15040244030058181fthe000000&tp=icon3';_kxs.setAttribute('size', 4);var _kx = document.getElementById('kx_verify');_kx.parentNode.insertBefore(_kxs, _kx);})();</script>
            <span id="bd_verify"><a rel="nofollow" href="//qwrz.baidu.com/id/875a07af2f196ccb5f19d1ee35ecec4e?qq-pf-to=pcqq.group" target="_blank"></a></span>
            <span id="icp_verify"><a rel="nofollow" href="//www.itrust.org.cn/yz/pjwx.asp?wm=1311685190" target="_blank"></a></span>
            <a href="//si.trustutn.org/info?sn=346160707000474986954" id="_pingansec_bottomimagesmall_p2p" target="_blank"><img src="/Public/images/common/netmoney.jpg" alt="互联网金融行业认证"></a>
            <script type="text/javascript" src="https://seal.websecurity.norton.com/getseal?host_name=www.wujiecaifu.com&amp;size=XS&amp;use_flash=YES&amp;use_transparent=YES&amp;lang=zh_cn"></script>
        </div>
    </div>
</footer>
<style type="text/css">
    footer{width:100%;height:350px;display:block;background:#555;color:#fff;position:relative;font-family:"microsoft yahei";}
    footer .container{top:33px;}
    footer .line{width:1220px;height:1px;display:block;position:absolute;top:36px;left:20px;background:#fff;filter:alpha(opacity=10);opacity:.1;}
    footer section{display:block;float:left;width:110px;height:210px;margin-right:140px;}
    footer section.security{margin-left:20px;}
    footer section ul,footer section ul li{list-style-type:none;}
    footer section li{font-size:14px;height:30px;line-height:30px;filter:alpha(opacity=80);opacity:0.8;}
    footer section .first{font-size:16px;height:36px;line-height:36px;margin-bottom:7px;filter:alpha(opacity=90);opacity:0.9;}
    footer section a{color:#fff;}
    footer section a:hover{color:#f60;}
    footer .ficon{width:31px;height:22px;display:block;float:left;}
    footer .service{width:210px;}
    footer .service li{height:34px;line-height:34px;}
    footer .service .bottom_num{font:30px/40px arial bold;height:40px;margin-bottom:6px;filter:alpha(opacity=100);opacity:1;}
    footer .qr{margin:0;width:130px;}
    footer .qr_bottom{height:121px;width:121px;background-position:-9px -9px;margin-bottom:4px;filter:alpha(opacity=100);opacity:1;float:none;}
    footer .follow{position:relative;}
    footer .sina{width:24px;height:19px;background-position:-104px -140px;display:inline-block;vertical-align:middle;}
    footer .sina:hover{background-position:-70px -140px;}
    footer .qq{width:20px;height:20px;background-position:-40px -140px;display:inline-block;vertical-align:middle;}
    footer .qq:hover{background-position:-10px -140px;}
    footer .phone{width:20px;height:20px;display:inline-block;background:url(../../images/common/icon3.png) no-repeat;margin-right:6px;vertical-align:text-top;}
    footer .service li.worktime{height:14px;line-height:14px;}
    footer .words{max-width:720px;height:auto;line-height:18px;display:block;margin:12px auto 8px;}
    footer .words a{color:#fff;margin-right:12px;}
    footer .words a:hover{text-decoration:underline;}
    footer .words div{float:left;text-align:center;}
    footer .instation,footer .links{margin-right:20px;}
    footer .instation{margin-left:86px;filter:alpha(opacity=90);opacity:.9;}
    footer .warn{filter:alpha(opacity=90);opacity:.9;}
    footer .links{width:100%;filter:alpha(opacity=70);opacity:.7;}
    footer .verify{width:690px;height:40px;background-position:0 -172px;margin:8px auto 0;float:none;filter:alpha(opacity=90);opacity:.9;}
    footer .verify #_pingansec_bottomimagesmall_p2p{width:110px;height:40px;margin-right:12px;}
    footer .verify #_pingansec_bottomimagesmall_p2p iframe{width:110px!important;height:40px!important;margin:-3px 0 0 -3px!important;}
    footer .verify > span{height:36px;display:inline-block;margin-left:8px;cursor:pointer;}
    footer a[logo_type="business"] img{width:95px;height:36px;}
    footer #bd_verify{width:102px;background:url(../../images/common/footer.png) no-repeat 0 -172px;}
    footer #icp_verify{width:113px;background:url(../../images/common/footer.png) no-repeat -102px -172px;margin-right:12px;}
    footer #bd_verify a,footer #icp_verify a{width:100%;height:100%;display:block;}
</style>

-----------------------------------------------------------------------
-----------------------------------------------------------------------
@StartTime: 2016-12-19 09:48:19

D:\wamp\www\wj\trunk\App\Tpl\Default\Index\index_new.html
<!-- php时间戳判断 -->
<?php if(time()>1484496000 && time()<1484582400){?>
    <img src="/Public/images/banner/bg20.jpg?465" class="holyimg">
<?php }else{ ?>
    <img src="/Public/images/banner/bg19.jpg?142" class="holyimg">
<?php } ?>
...
#vforsms .sure_button_index{background:#f60;border:1px solid #f60;color:#fff;font-size:14px;}
