	...
	$.swipebox = function(elem, options) {
		...
		var defaults = {
			...
			html = '<div id="swipebox-overlay">\
					...
					<div id="swipebox-action">\
						<span id="swipebox-close"></span>\
						<span id="swipebox-prev"></span>\
						<span id="swipebox-next"></span>\
					</div>\
		...
		var ui = {
			...
			closeSlide : function (){
				...
				//解除a标签 return false事件
				var clearClickTag = setTimeout(function(){
					var onclickAttr = "";
//					$("a[class!='swipebox']").each(function(){//排除图库标签
//						onclickAttr = $(this).attr('onclick');
//						if(onclickAttr!="" && typeof(onclickAttr)!='undefined'){//排除有onclick事件的a标签
//							return;
//						}
//						$(this).trigger("click");
//					});
					//加上bind click事件
					elem.swipebox(options);
					//清除定时任务
					window.clearTimeout(clearClickTag);
				},1000);
